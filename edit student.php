...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Retrieve the existing student data from the database
        ...
        $sql = "UPDATE student SET first_name = '$firstName', last_name = '$lastName', email = '$email', user_name = '$username' WHERE student_id = $studentId";
    ...
    if (isset($_GET['student_id'])) {
        ...
        $sql = "SELECT student_id,first_name,last_name,email,user_name FROM student WHERE student_id = $studentId";
